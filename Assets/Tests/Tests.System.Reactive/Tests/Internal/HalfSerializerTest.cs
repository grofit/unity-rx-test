...
namespace ReactiveTests.Tests
{
    ...
    //        Assert.AreEqual(0, _wip);
    //        Assert.Null(_error);

    //        Assert.AreEqual(1, _consumer.Items.Count);
    //        Assert.AreEqual(1, _consumer.Items[0]);
    //        Assert.AreEqual(0, _consumer.Done);
    ...
    //        Assert.AreEqual(1, _wip);
    //        Assert.AreEqual(_error, ExceptionHelper.Terminated);

    //        HalfSerializer.ForwardOnNext(_consumer, 2, ref _wip, ref _error);

    //        Assert.AreEqual(0, _consumer.Items.Count);
    //        Assert.AreEqual(0, _consumer.Done);
    //        Assert.AreEqual(ex, _consumer.Exc);
    //    }
    ...
    //        Assert.AreEqual(0, _consumer.Items.Count);
    //        Assert.AreEqual(1, _consumer.Done);
    //        Assert.Null(_consumer.Exc);
    //    }
    ...
    //        Assert.AreEqual(1, _consumer.Items[0]);
    //        Assert.AreEqual(0, _consumer.Done);
    //        Assert.AreEqual(c.X, _consumer.Exc);
    //    }
