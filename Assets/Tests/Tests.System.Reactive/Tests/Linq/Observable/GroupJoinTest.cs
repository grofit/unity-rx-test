...
{
    public partial class GroupJoinTest : ReactiveTest
    {
        ...
        {
            XunitAssert.Equal(xs.Messages.Where(x => x.Value.Kind == NotificationKind.OnNext && x.Time <= lastEnd).Count(), xsd.Count);
