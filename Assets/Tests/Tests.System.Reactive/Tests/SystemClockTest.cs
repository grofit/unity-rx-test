...
namespace ReactiveTests.Tests
{
    ...
    public partial class SystemClockTest
    {
        ...
        private static void PastWork_Callback()
        {
            ...
            XunitAssert.Equal(1, s._queue.Count);
        ...
        private static void LongTermWork1_Callback()
        {
            ...
            XunitAssert.Equal(1, cal._queue.Count);
        ...
        private static void ClockChanged_Forward1_Callback()
        {
            ...
            XunitAssert.Equal(1, cal._queue.Count);
            XunitAssert.Equal(0, s._queue.Count);
            ...
            XunitAssert.Equal(0, cal._queue.Count);
            XunitAssert.Equal(0, s._queue.Count);
        }
        ...
        private static void ClockChanged_Forward2_Callback()
        {
            ...
            XunitAssert.Equal(1, n); // Invoke shouldn't cause double execution of the work.
        }
